...
HD_PWD='P:/25summer/engs031/Groups/GoldenGiraffe/Snake/Snake.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_toplevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_toplevel.tcl -notrace
