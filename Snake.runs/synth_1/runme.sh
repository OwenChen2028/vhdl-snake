...
HD_PWD='P:/25summer/engs031/Groups/GoldenGiraffe/Snake/Snake.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_toplevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_toplevel.tcl
