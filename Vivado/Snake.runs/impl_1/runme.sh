...
HD_PWD='P:/25summer/engs031/Groups/GoldenGiraffe/Vivado/Snake.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log helper_fsm_toplevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source helper_fsm_toplevel.tcl -notrace
