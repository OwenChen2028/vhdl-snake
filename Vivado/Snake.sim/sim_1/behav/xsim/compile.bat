...
REM
REM Generated by Vivado on Thu Aug 21 22:34:32 -0400 2025
...
echo "xvhdl --incr --relax -prj game_fsm_tb_vhdl.prj"
call xvhdl  --incr --relax -prj game_fsm_tb_vhdl.prj -log xvhdl.log
