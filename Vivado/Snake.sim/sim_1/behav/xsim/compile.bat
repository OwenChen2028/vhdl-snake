...
REM
REM Generated by Vivado on Mon Aug 25 10:14:15 -0400 2025
...
echo "xvhdl --incr --relax -prj pixelgen_tb_vhdl.prj"
call xvhdl  --incr --relax -prj pixelgen_tb_vhdl.prj -log xvhdl.log
