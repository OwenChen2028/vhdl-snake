...
REM
REM Generated by Vivado on Sun Aug 24 14:03:09 -0400 2025
...
echo "xvhdl --incr --relax -prj grid_fsm_tb_vhdl.prj"
call xvhdl  --incr --relax -prj grid_fsm_tb_vhdl.prj -log xvhdl.log
